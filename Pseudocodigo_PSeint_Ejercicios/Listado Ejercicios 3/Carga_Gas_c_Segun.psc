Algoritmo Carga_Gas
	// DEFINIMOS VARIABLES
	Definir tipo_gas, tipo_gas_txt, monto_carga, medio_pago, i Como Entero;
	...
	Escribir "";
		...
		Si medio_pago == 1 Entonces
			dcto = ((Redon(monto_carga * 0.10) * 10) / 10); // APLICAMOS UN DESCUENTO DEL 10% SI LA OPCION DE PAGO ASI LO REQUIERE
